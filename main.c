...
int main(int argc, char *argv[])
{
	...
	else
	{
		printf("\n");
		printf("-----------------------------------------------------------------------------------\n");
		printf(".dP Y8 88b 88 888888 .dP Y8          8888b.  88   88 8b    d8 88  Yb 888888 88  Yb \n");
		printf("`Ybo.  88Yb88 88__   `Ybo.  ________  8I  Yb 88   88 88b  d88 88__dP 88__   88__dP \n");
		printf("o.`Y8b 88 Y88 88""   o.`Y8b """"""""  8I  dY Y8   8P 88YbdP88 88     88     88 Yb  \n");
		printf(" 8bodP' 88  Y8 888888 8bodP'          8888Y    YbodP 88 YY88  88     888888 88  Yb \n");
		printf("-----------------------------------------------------------------------------------\n");
		printf("\n");
